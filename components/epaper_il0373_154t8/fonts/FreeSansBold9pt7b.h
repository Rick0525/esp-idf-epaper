...
// 经 Adafruit 包装后以 BSD 3-clause 许可证分发。本文件仅做以下本地化：
//   - 把 `#include <Adafruit_GFX.h>` 改为 `#include "gfxfont.h"`（IDF 路径）
//   - 字体本体数据（bitmap[] / glyph[] / GFXfont）一字未改
//
// 字体源 BSD 版权见 components/epaper_154/include/gfxfont.h
// FreeFont 字体本体使用 GPL with font-embedding exception，允许嵌入二进制
// 分发；详见 https://www.gnu.org/software/freefont/
